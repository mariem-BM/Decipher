 ...
 */
final class Version20220228161358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE billet (id INT AUTO_INCREMENT NOT NULL, localisation_id INT DEFAULT NULL, chair_billet INT NOT NULL, voyage_num INT NOT NULL, terminal INT NOT NULL, portail INT NOT NULL, embarquement DATE NOT NULL, INDEX IDX_1F034AF6C68BE09C (localisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE planinng (id INT AUTO_INCREMENT NOT NULL, localisation_id INT DEFAULT NULL, nom_planning VARCHAR(255) NOT NULL, date_debut_planning DATE NOT NULL, date_fin_planning DATE NOT NULL, destination_planning VARCHAR(255) NOT NULL, activites_planning LONGTEXT NOT NULL, description_planning LONGTEXT NOT NULL, periode_planning DOUBLE PRECISION NOT NULL, prix_planning DOUBLE PRECISION NOT NULL, INDEX IDX_4C0191CAC68BE09C (localisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, billet_id INT DEFAULT NULL, date_reservation DATE NOT NULL, nbrebillet INT NOT NULL, etat_reservation VARCHAR(255) NOT NULL, INDEX IDX_42C84955A76ED395 (user_id), INDEX IDX_42C8495544973C78 (billet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
