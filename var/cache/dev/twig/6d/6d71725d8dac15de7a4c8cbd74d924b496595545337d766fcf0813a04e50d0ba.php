...
/* baseback/base.html.twig */
class __TwigTemplate_b15c5d8599760207a36ef67507452631d410ea23e86bcba18685250389c4c976 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "baseback/base.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "baseback/base.html.twig"));
...
\t\t\t\t\t<span class=\"ms-1 font-weight-bold\">Celestial Dashboard</span>
\t\t\t\t</a>
\t\t\t</div>
...
\t\t\t\t\t\t<a class=\"nav-link  active\" href=\"";
        // line 48
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("baseback");
        echo "\">
...
\t\t\t\t\t\t\t\t</svg>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<span class=\"nav-link-text ms-1\">Offer Management</span>
\t\t\t\t\t\t</a>
\t\t\t\t\t<a class=\"nav-link  \" href=\"../pages/billing.html\">
\t\t\t\t\t\t\t<div class=\"icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center\">
\t\t\t\t\t\t\t\t<svg width=\"12px\" height=\"12px\" viewbox=\"0 0 42 42\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\">
...
\t\t\t\t\t\t\t\t</svg>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<span class=\"nav-link-text ms-1\">Reclamation Management</span>
...
\t\t\t\t\t\t\t\t</svg>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<span class=\"nav-link-text ms-1\">planning Management</span>
\t\t\t\t\t\t\t<a class=\"nav-link  \" href=\"../pages/tables.html\">
\t\t\t\t\t\t\t\t<div class=\"icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center\">
\t\t\t\t\t\t\t\t\t<svg width=\"12px\" height=\"12px\" viewbox=\"0 0 42 42\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\">
\t\t\t\t\t\t\t\t\t\t<title>office</title>
...
\t\t\t\t\t\t\t\t</svg>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<span class=\"nav-link-text ms-1\">Equipement Category Management</span>
\t\t\t\t\t\t\t<a class=\"nav-link  \" href=\"../pages/tables.html\">
\t\t\t\t\t\t\t\t<div class=\"icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center\">
\t\t\t\t\t\t\t\t\t<svg width=\"12px\" height=\"12px\" viewbox=\"0 0 42 42\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\">
\t\t\t\t\t\t\t\t\t\t<title>office</title>
...
\t\t\t\t\t\t\t\t\t</svg>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<span class=\"nav-link-text ms-1\">Equipement Management</span>
...
\t\t\t\t\t\t\t\t</svg>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<span class=\"nav-link-text ms-1\">Post Category Management</span>
...
\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 536, $this->source); })()), "flashes", [0 => "success"], "method", false, false, false, 536));
...
\t\t\t\t<link id=\"pagestyle\" href=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("Back/assets/css/soft-ui-dashboard.css?v=1.0.3"), "html", null, true);
        echo "\" rel=\"stylesheet\"/>
\t\t\t";
...
\t\t\t\t<script src=\"";
        // line 587
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("Back/assets/js/plugins/chartjs.min.js"), "html", null, true);
        echo "\"></script>
\t\t\t\t<script>
...
\t\t\t\t<script src=\"";
        // line 822
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("Backassets/js/soft-ui-dashboard.min.js?v=1.0.3"), "html", null, true);
        echo "\"></script>
\t\t\t";
    ...
    {
        return "baseback/base.html.twig";
    }
    ...
    {
        return array (  1065 => 822,  827 => 587,  823 => 586,  819 => 585,  815 => 584,  810 => 583,  808 => 582,  798 => 581,  742 => 543,  724 => 541,  712 => 28,  707 => 26,  700 => 22,  695 => 20,  688 => 16,  683 => 15,  681 => 14,  671 => 13,  651 => 8,  638 => 30,  635 => 13,  632 => 10,  630 => 8,  624 => 4,  614 => 3,  601 => 824,  598 => 581,  596 => 543,  593 => 542,  590 => 541,  581 => 538,  578 => 537,  574 => 536,  519 => 484,  497 => 465,  316 => 287,  74 => 48,  63 => 40,  55 => 34,  53 => 3,  49 => 1,);
    }
...
\t\t\t<meta name=\"viewport\" content=\"width=device-width, initial-scale=1, shrink-to-fit=no\">
\t\t\t<title>
\t\t\t\t{% block title %}Celestial Dashboard
\t\t\t\t{% endblock %}
\t\t\t</title>
...
\t\t\t\t<link
\t\t\t\thref=\"{{ asset ('Back/assets/css/nucleo-svg.css')}}\" rel=\"stylesheet\"/>
\t\t\t\t<!-- Font Awesome Icons -->
\t\t\t\t<script src=\"https://kit.fontawesome.com/42d5adcbca.js\" crossorigin=\"anonymous\"></script>
\t\t\t\t<link
\t\t\t\thref=\"{{ asset ('Back/assets/css/nucleo-svg.css')}}\" rel=\"stylesheet\"/>
...
\t\t\t\t<i class=\"fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none\" aria-hidden=\"true\" id=\"iconSidenav\"></i>
\t\t\t\t<a class=\"navbar-brand m-0\" href=\"https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html\" target=\"_blank\">
\t\t\t\t\t<img src=\"{{ asset ('Front/img/logo.png')}}\" class=\"navbar-brand-img h-100\" alt=\"main_logo\">
\t\t\t\t\t<span class=\"ms-1 font-weight-bold\">Celestial Dashboard</span>
\t\t\t\t</a>
\t\t\t</div>
\t\t\t<hr class=\"horizontal dark mt-0\">
...
\t\t\t\t<ul class=\"navbar-nav\">
\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t<a class=\"nav-link  active\" href=\"{{path('baseback')}}\">
\t\t\t\t\t\t\t<div class=\"icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center\">
\t\t\t\t\t\t\t\t<svg width=\"12px\" height=\"12px\" viewbox=\"0 0 45 40\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\">
\t\t\t\t\t\t\t\t\t<title>shop
\t\t\t\t\t\t\t\t\t</title>
...
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<span class=\"nav-link-text ms-1\">Post Category Management</span>
\t\t\t\t\t\t<a class=\"nav-link  \" href=\"{{path('post_index')}}\">
\t\t\t\t\t\t\t\t<div class=\"icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center\">
\t\t\t\t\t\t\t\t\t<svg width=\"12px\" height=\"12px\" viewbox=\"0 0 42 42\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\">
\t\t\t\t\t\t\t\t\t\t<title>office</title>
\t\t\t\t\t\t\t\t\t\t<g stroke=\"none\" stroke-width=\"1\" fill=\"none\" fill-rule=\"evenodd\">
...
\t\t\t\t<!--   Core JS Files   --><script src=\"{{ asset ('Back/assets/js/core/popper.min.js')}}\"> </script>
...
\t\t\t\t<script async defer src=\"https://buttons.github.io/buttons.js\"></script>
\t\t\t\t<!-- Control Center for Soft Dashboard: parallax effects, scripts for the example pages etc -->
\t\t\t\t<script src=\"{{ asset ('Backassets/js/soft-ui-dashboard.min.js?v=1.0.3')}}\"></script>
\t\t\t{% endblock %}
\t\t</body>
\t</body>
</html>
", "baseback/base.html.twig", "C:\\Users\\zeineb\\Documents\\GitHub\\d2\\Decipher\\templates\\baseback\\base.html.twig");
    }
}
