...
/* post/show.html.twig */
class __TwigTemplate_ce98ec4a5c060b98195ec717103fd968a4569fad4515fd739f1f037587905b32 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("baseback/base.html.twig", "post/show.html.twig", 1);
...
\t\t\t<tr>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 18
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 18, $this->source); })()), "nomPost", [], "any", false, false, false, 18), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Img_post</th>
                <td>";
        // line 22
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 22, $this->source); })()), "imgPost", [], "any", false, false, false, 22), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                ...
                <td>";
        // line 26
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 26, $this->source); })()), "descriptionPost", [], "any", false, false, false, 26), "html", null, true);
        echo "</td>
            </tr>
\t\t</tbody>
\t</table>
...
";
    ...
    {
        return array (  135 => 34,  130 => 32,  125 => 30,  118 => 26,  111 => 22,  104 => 18,  97 => 14,  89 => 8,  79 => 7,  59 => 4,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% extends ('baseback/base.html.twig') %}
...
{% endblock %}
", "post/show.html.twig", "C:\\Users\\zeineb\\Documents\\GitHub\\d2\\Decipher\\templates\\post\\show.html.twig");
    }
}
